      ...
      {currentmsg == currentelm && edit && (
        <>
          <form
            action=""
            onSubmit={
              action == "editcommentgame"
                ? handleEditGameComment
                : action == "editcommentreview"
                ? handleEditReviews
                : action == "editcommentgamepost"
                ? "futurfonceditpostocmment"
                : "editcommentpost"
                ? ""
                : "futurfuncquieditpostreview"
            }
          ...
          >
            <div className="comment-edit-section">
              ...
              <input
                type="submit"
                value="modifier"
                className="submit-btn-edit-comment"
              />
            </div>
            <br />
            {/* <div className="btn">
