...
import { faCircleXmark, faEdit, faPeace, faTrash } from "@fortawesome/free-solid-svg-icons";
              ...
              <div className="right-part">
                <div className="comment-header">
                  <div className="pseudo">
                    <h3><a href="">{comment.commenterPseudo}</a></h3>
                    {/* {comment.commenterId !== userData._id && (
                      <FollowHandler
            ...
            <span onClick={() => {
                ...
                <p>{comment.text}</p>
             {
              editpost  === true && comment?._id  === currentmsg ? (<> 
                 <EditDeleteCommenter comment={comment}  edit={editpost} setEdit={setEditPost} currentmsg={comment._id} action={'editcommentpost'} currentelm={comment._id}/></>)
                  : ''
             }
